...
urlpatterns = [
    ...
    url(r'^events_this_month$', views.event_type, name='events_this_month'),
    url(r'^event_type_last_month/(?P<event_type>[0-9]+)$', views.event_type, name='event_type_last_month'),
    url(r'^events_last_month$', views.event_type, name='events_last_month'),
    url(r'^event_type_this_year/(?P<event_type>[0-9]+)$', views.event_type, name='event_type_this_year'),
    url(r'^events_this_year$', views.event_type, name='events_this_year'),
    url(r'^events_all_time$', views.event_type, name='events_all_time'),
